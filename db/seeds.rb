...
Location.create(user_id: 1, location_type_id: 1, name: 'test dog park', address: '655 Westernport Hwy',
                description: 'A fun dogpark for all to come and play!')
Location.create(user_id: 1, location_type_id: 4, name: 'bunnings', address: '675/685 Warrigal Rd, Chadstone VIC 3148',
                description: 'Dogs can come into the store on lead.')
Location.create(user_id: 1, location_type_id: 3, name: 'Chelsea beach', address: 'chelsea beach, chelsea, vic 3196',
